...
function(declare, BaseWidget, on, lang, LayerChooserFromMap, LayerChooserFromMapWithDropbox, Select, Button, CheckBox, domConstruct, registry,
  ...
  return declare([BaseWidget], {
    ...
    displayChart: function(){
      ...
      this.chart.show({
        elementId: "#chart",
        autolabels: true,
        width: this.getPanel().boxNode.clientWidth * 0.9,
        height: 275
      });
    },

    resize: function(){
      this.chart.width = this.getPanel().boxNode.clientWidth * 0.9
      this.chart.update()
    },
